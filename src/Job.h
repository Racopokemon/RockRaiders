...
class Job {
    public :
        ...
        //If there is no worker with us, then we are still in a joblist, that we have to leave. 
        void cancelBySystem();
        ...
        //* Cancelled by System: We are owned by a JobDoer or by the joblist, cancelBySystem() ends this
